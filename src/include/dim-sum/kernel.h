#ifndef _DIM_SUM_KERNEL_H
#define _DIM_SUM_KERNEL_H
...
#define might_sleep() do { __might_sleep(__FILE__, __func__, __LINE__); } while (0)
...
extern __printf(2, 3)
char *kasprintf(paf_t paf, const char *fmt, ...);
extern char *kvasprintf(paf_t paf, const char *fmt, va_list args);
