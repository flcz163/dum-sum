...
__extern __noreturn void _exit(int);
...
__extern int symlinkat(const char __user * oldname,
			      int newdfd, const char __user * newname);
__extern int readlink(const char *, char *, size_t);
__extern int readlinkat(int dfd, const char __user *path, char __user *buf,
			       int bufsiz);
...
/* Also in <fcntl.h> */
#ifdef _KLIBC_IN_OPEN_C
__extern int open(const char *pathname, int flags, mode_t mode);
...
__extern ssize_t read(unsigned int fd, char __user * buf, size_t count);
__extern ssize_t write(unsigned int fd, const char __user * buf, size_t count);
__extern ssize_t pread(int, void *, size_t, off_t);
__extern ssize_t pwrite(unsigned int fd, const char __user *buf,
				size_t count, loff_t pos);

__extern int dup(int);
__extern int dup2(int, int);
__extern int dup3(int, int, int);
__extern int fcntl(unsigned int fd, unsigned int cmd, unsigned long arg);
__extern int ioctl(int, int, void *);
__extern int truncate(char *, unsigned long);
__extern int ftruncate(unsigned int, unsigned long);
