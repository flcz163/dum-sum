 ...
 * value, otherwise it returns -EINVAL and *res is set to 0.
 */
__maybe_unused static int strict_strtol(const char *cp, unsigned int base, long *res)
{
	int ret;
	if (*cp == '-') {
 ...
 * return the converted value of prefix part of the string.
 */
static int strict_strtoull(const char *cp, unsigned int base, unsigned long long *res)
{
	char *tail;
 ...
 * value, otherwise it returns -EINVAL and *res is set to 0.
 */
__maybe_unused static int strict_strtoll(const char *cp, unsigned int base, long long *res)
{
	int ret;
	if (*cp == '-') {
