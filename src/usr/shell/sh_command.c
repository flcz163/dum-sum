...
__maybe_unused static int sh_cmd_run_task(void *data)
{
...
#if 0
		child_id = create_process(sh_cmd_run_task, (void *)sh_cmd_run, sh_cmd->name, 20);
...
static void _initialize_comm_cmds(void)
{
